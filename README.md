...
- [ ] 图论
    ...
    - [x] 判断拓扑排序 A1146
    - [x] 欧拉通路、回路，哈密顿通路、回路
        - [x] 判断所给的点是否构成哈密顿图 A1122
        - [x] 判断这个图是否含有欧拉路,欧拉回路 A1126
    ...
    - [ ] 树
        - [ ] 遍历
            ...
            - [ ] 中序遍历 递归、非递归实现
            - [x] 给出先序中序求后序 A1138
            - [x] 给出后序中序求先序、层序 A1020
            - [x] 给出先序后序求可能的中序(重要)
                - tips: 只要父亲节点只包含一个子节点，那么这个答案是不唯一的
                - [x] A1119
            - [x] 层序遍历
            - [x] Z字形遍历 挺重要的感觉 A1127
            - [x] 多叉树遍历
                - [x] A1079
                - [x] A1090
                - [x] A1094
            - [x] 遍历，同时记录结点重要信息 2019年春季考试 7-4 Structure of a Binary Tree（30分）
        - [ ] LCA
            - [ ] A1151
            - [ ] A1143
    ...
    - [x] 并查集
        - [x] 基础模板
            ...
            - [x] A1114
            - [x] A1107
            - [x] 2019年春季考试 7-3 Telefraud Detection (25分) 
        - 路径优化
- [ ] 排序
    - [x] 插入排序 A1089, A1098
    - [ ] 归并排序
